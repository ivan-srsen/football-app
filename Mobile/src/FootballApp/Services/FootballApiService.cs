...
namespace FootballApp.Services
{
    public class FootballApiService
    {
        ...
        private const string ApiBaseUrl = "http://10.0.2.2:7222";
        ...
        public FootballApiService(HttpClient httpClient, TokenService tokenService)
        {
        ...
        public async Task PostRegisterAsync(RegisterRequest request)
        {
            ...
            //await _httpClient.PostAsync<RegisterRequest>("/accounts/register", request);
            await _httpClient.GetAsync("accounts/test");
        }
